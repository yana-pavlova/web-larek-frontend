...
- слой представления (вью) отвечает за отображение данных на странице; представлен следующими классами: View, ItemView, CartView, ContactsFormView, OrderFormView, SuccessWindowView, ModalView
...
#### Класс OrderFormView
Принадлежит слою представления (вью). Наследует от View. Генерирует кастомные события формы. Публичных методов не имеет.
